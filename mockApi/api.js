...
app.get('/posts/maps', async (_req, res) => res.json({ maps: ['Ascent', 'Bind'] }));
app.get('/posts/agents/Ascent', async (_req, res) => res.json({ agents: ['Viper', 'Cypher'] }));
app.get('/posts/agents/Bind', async (_req, res) => res.json({ agents: ['Sage', 'Sova'] }));
