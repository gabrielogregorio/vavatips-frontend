    ...
    <div className="w-full dark:bg-skin-gray-900 bg-skin-secondary-light flex justify-center">
      <div className="grid gap-2 grid-cols-1 w-full p-5 max-w-maxWidthDefault sm:grid-cols-3">
        <div className="flex mb-4 flex-col">
          <h3 className="text-lg text-skin-gray-400 font-semibold text-left">Contribua</h3>
          <a
            className="text-skin-gray-400 text-sm"
            target="_blank"
        ...
        <div className="w-full mb-4 text-center">
          <h3 className="text-lg text-skin-gray-400 font-semibold text-left">Projeto</h3>
          <p className="text-left text-sm text-skin-gray-400">
        ...
        <div className="w-full mb-4 text-center">
          <h3 className="text-lg text-skin-gray-400 font-semibold text-left">Sobre</h3>
          <p className="text-left text-sm text-skin-gray-400">
